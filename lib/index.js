...
module.exports._flatten = function(obj) {
...
// @todo write tests
// @todo write docs
module.exports._objectify = function(path, value, returnObj = {}) {
  ...
  if (path.length > 0) {
    this._objectify(path, value, returnObj[firstPath]);
  } else {
...
module.exports.getValues = function(
  ...
  let merged = {};
  let flattenedSchema = this._flatten(schema);
